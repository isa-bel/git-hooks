#!/bin/sh
#
# Applies the commit message guidelines from https://chris.beams.io/posts/git-commit/
...
testRegex "$subject_line" '^[a-z]' 'Subject line is not capitalized'
